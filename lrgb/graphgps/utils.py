...
def make_wandb_name(cfg):
    ...
    # important: added by Chen
    dataset_name = dataset_name.replace('VOCSuperpixels', 'voc')
    dataset_name = dataset_name.replace('COCOSuperpixels', 'coco')
    ...
    # important: added by Chen
    dataset_name = dataset_name.replace('edge_wt_region_boundary', 'bdy')
    dataset_name = dataset_name.replace('PCQM4Mv2Contact-shuffle', 'PCQM')
    dataset_name = dataset_name.replace('..', '.')
    # Format model name.
    model_name = ''  # cfg.model.type # important: modified by chen
