# almost the same as laplace_pos_encoder.py except the eigevalues are not used.
import torch
...
class LapPEVecNodeEncoder(torch.nn.Module):
    ...
    def forward(self, batch):
        ...
        EigVals = torch.zeros_like(batch.EigVals)
...
register_node_encoder('LapPEVec', LapPEVecNodeEncoder)
