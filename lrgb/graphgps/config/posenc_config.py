...
def set_cfg_posenc(cfg):
    ...
    for name in ['posenc_LapPE', 'posenc_LapPEVec', 'posenc_SignNet',
    ...
    for name in ['posenc_LapPE', 'posenc_LapPEVec','posenc_SignNet', 'posenc_EquivStableLapPE']:
        pecfg = getattr(cfg, name)
        pecfg.eigen = CN()
