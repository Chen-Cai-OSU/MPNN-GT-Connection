...
def compute_posenc_stats(data, pe_types, is_undirected, cfg):
    ...
    # Verify PE types.
    for t in pe_types:
        if t not in ['LapPE', 'EquivStableLapPE', 'SignNet', 'RWSE', 'HKdiagSE', 'HKfullPE', 'ElstaticSE', 'LapPEVec']:
    ...
    if 'LapPE' in pe_types or 'EquivStableLapPE' in pe_types or 'LapPEVec' in pe_types:

        try:
            evals, evects = data.evals, data.evects
            data.evals, data.evects = None, None
        except:
        ...
        if 'LapPE' in pe_types or 'LapPEVec' in pe_types:
    ...
    if 'SignNet' in pe_types:
        ...
        try:
            evals_sn, evects_sn = data.evals, data.evects
            data.evals, data.evects = None, None
        except:
