...
model = MLP(input_dim = num_nodes * window, hidden_dim = args.hidden_dim, output_dim = num_nodes).to(device = device)
...
for epoch in range(num_epoch):
    ...
    for batch_idx, data in enumerate(train_dataloader):
        ...
        images = torch.reshape(node_feat, (batch_size, num_nodes * window))
