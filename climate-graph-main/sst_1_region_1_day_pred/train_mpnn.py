...
train_dataset = oisstv2_dataset(dataset = dataset, slice_index = train_slice, window = window, virtual_node = virtual_node)
valid_dataset = oisstv2_dataset(dataset = dataset, slice_index = valid_slice, window = window, virtual_node = virtual_node)
test_dataset = oisstv2_dataset(dataset = dataset, slice_index = test_slice, window = window, virtual_node = virtual_node)
