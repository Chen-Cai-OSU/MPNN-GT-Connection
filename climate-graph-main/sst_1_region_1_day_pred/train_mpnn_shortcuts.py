...
def _parse_args():
    ...
    parser.add_argument('--num_shortcuts', '-num_shortcuts', type = int, default = 100, help = 'Number of shortcuts')
...
indices, values = create_adj(num_longitudes, num_latitudes, num_shortcuts = num_shortcuts)
adj = (indices, values)
