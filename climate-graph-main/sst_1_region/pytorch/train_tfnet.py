...
for epoch in range(num_epoch):
    ...
    for batch_idx, data in enumerate(train_dataloader):
        ...
        images_ = torch.zeros(batch_size, history_window, num_longitudes + 4, num_latitudes + 4).to(device = device)
        ...
        predict = torch.reshape(predict[:, :, 2 : num_longitudes + 2, 2 : num_latitudes + 2], (batch_size, predict_window, num_longitudes * num_latitudes))
