...
from gnn import GNN # Non-heterogenous GNN
...
print('Use non-heterogenous graph')
LOG.write('Use non-heterogenous graph' + '\n')

lon_filter = args.lon_filter
lat_filter = args.lat_filter

train_dataset = oisstv2_dataset_pyg(raw_datasets = raw_datasets, split = 'train', history_window = history_window, predict_window = predict_window, lon_filter = lon_filter, lat_filter = lat_filter, hetero = False)
valid_dataset = oisstv2_dataset_pyg(raw_datasets = raw_datasets, split = 'valid', history_window = history_window, predict_window = predict_window, lon_filter = lon_filter, lat_filter = lat_filter, hetero = False)
test_dataset = oisstv2_dataset_pyg(raw_datasets = raw_datasets, split = 'test', history_window = history_window, predict_window = predict_window, lon_filter = lon_filter, lat_filter = lat_filter, hetero = False)
...
# For visualization
num_longitudes = test_dataset.num_longitudes
num_latitudes = test_dataset.num_latitudes
...
np.save('MPNN.predict', saved_predict)
np.save('MPNN.target', saved_target)
